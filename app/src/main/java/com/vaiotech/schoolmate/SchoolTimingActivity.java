...
public class SchoolTimingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        modelService = new ModelService(this.selectedSchool.split("-")[0].trim() , "7");
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.school_timing, menu);
        return true;
    }
